...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-bandaflow-local-key-xyz123')

# SECURITY WARNING: don't run with debug turned on in production!
# This checks if there is a 'DEBUG' environment variable set to 'True'
...
# Uses DATABASE_URL from environment or the default link provided
DATABASES = {
...
# Password validation - kept empty as per your school project request
